...
const ctxMap = new WeakMap<HTMLElement, ContextEntry>();
...
export default function Scanner({
  ...
  useEffect(() => {
    ...
    const col1 = u.uColor1.value as Float32Array;
    const col2 = u.uColor2.value as Float32Array;
    const col3 = u.uColor3.value as Float32Array;
    col1[0] = c1[0];
    col1[1] = c1[1];
    col1[2] = c1[2];
    col2[0] = c2[0];
